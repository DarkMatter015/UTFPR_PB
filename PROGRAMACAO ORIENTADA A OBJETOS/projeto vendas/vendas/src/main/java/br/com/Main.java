...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        VendaService vendaService =  new VendaService(manager);
    ...
    private static void consultarPedidosPorPeriodo(PedidoService pedidoService) {
        ...
        List<Pedido> pedidos = pedidoService.buscarPedidosPorPeriodo(dataInicio, dataFim);
        if (!pedidos.isEmpty()) {
    ...
    private static void consultarPedidosDeCliente(PedidoService pedidoService) {
        ...
        List<Pedido> pedidos = pedidoService.buscarPedidosDeUmCliente(clienteId);
        if (!pedidos.isEmpty()) {
